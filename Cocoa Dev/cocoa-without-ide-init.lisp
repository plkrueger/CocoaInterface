;; cocoa-without-ide-init.lisp

;; an exact copy of cocoa.lisp except for second to last line.
...
(setf gui::*ccl-ide-init-file* "") ;; to prevent loading the user's ccl-ide-init-file
(gui::start-cocoa-ide)